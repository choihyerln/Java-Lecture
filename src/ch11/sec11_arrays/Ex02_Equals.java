...
public class Ex02_Equals {
	...
	public static void main(String[] args) {
		...
		// 배열 번지 비교
		System.out.println(Arrays.equals(src2d, new2d));	// 메모리 위치는 다르지만,
		// 배열의 값 비교
		System.out.println(Arrays.deepEquals(src2d, new2d));	// 값은 같아
		
		new2d[0][0] = 3;
		System.out.println(Arrays.deepEquals(src2d, new2d));	// new2d 값 변경했으니까 false
